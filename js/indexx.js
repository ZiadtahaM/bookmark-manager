...
var boxModal = document.querySelector(".information");
var bookmarks = [];

if (localStorage.getItem("bookmar")) {
 bookmarks = JSON.parse(localStorage.getItem("bookmar"));
...
submitBtn.addEventListener("click", function () {
 ...
 localStorage.setItem("bookmar", JSON.stringify(bookmarks));
...
function handleCloseModal(e) {
 if (e.type === "click" && e.target.classList.contains("information")) {
 closeModal();
